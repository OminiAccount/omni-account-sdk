import { hexlify, toBeArray, toUtf8Bytes, zeroPadValue, } from 'ethers';
 ...
 * @throws
 */
export function packUints(high128, low128) {
    ...
    const highBytes = zeroPadValue(toBeArray(addHexPrefix(high128.toString(16))), 16);
    const lowBytes = zeroPadValue(toBeArray(addHexPrefix(low128.toString(16))), 16);
 ...
 *    //_result:
 */
export async function poseidonId(value) {
