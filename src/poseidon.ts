 ...
 * @returns {Promise<Poseidon>} poseidon function
 */
async function buildPoseidon(): Promise<Poseidon> {
  ...
  const MDIAG: BigIntArray = [8n, 0n, 0n, 0n, 0n, 0n, 0n, 0n, 0n, 0n, 0n, 0n];
